...
<section class="su-container">
        <div class="signup">
            <h1 class="main-title">Login TO THE Seller Account</h1>
            <div class="signup-form">
               <form action="login" method="post">
                   
                        <input class="input_field" required placeholder="Enter Email" type="text" name="email" id="email"  />
                        <input class="input_field" required placeholder="Enter Password" type="text" name="password"  id="password"/>
